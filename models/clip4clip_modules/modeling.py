...
class CLIP4ClipPreTrainedModel(PreTrainedModel, nn.Module):
    ...
    def from_pretrained(cls, cross_model_name, state_dict=None, cache_dir=None, type_vocab_size=2, *inputs, **kwargs):
        ...
        model = cls(cross_config, clip_state_dict,
                    task_config=task_config, *inputs, **kwargs)
                    ...
                    if model.sim_header == "seqTransf" and key.find("transformer.resblocks") == 0:
                        ...
                        if num_layer < task_config.cross_num_hidden_layers:
                            state_dict[key.replace(
                                "transformer.", "transformerClip.")] = val.clone()
                            continue
    ...
    def _loose_similarity(self, sequence_output, visual_output, attention_mask, video_mask, sim_header="meanP"):
        ...
        if sim_header == "meanP":
            ...
            position_ids = position_ids.unsqueeze(
                0).expand(visual_output.size(0), -1)
        ...
        retrieve_logits = logit_scale * \
            torch.matmul(sequence_output, visual_output.t())
