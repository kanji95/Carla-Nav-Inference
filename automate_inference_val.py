import os
episodes = [15, 20]+list(range(25, 25))
...
for i in range(len(episodes)):
    os.system(f"python inference_model.py --img_backbone iros --hidden_dim 384 --image_dim 224 --mask_dim 224 --traj_dim 224 --sync --threshold 0.00005 \
