...
checkpoint = './saved_model/clip_ViT-B_32_class_level_combo_multi_head_hd_512_sf_10-8_tf_10_12_May_05_13.pth'
...
for i in range(len(episodes)):
    os.system(f"python inference_model.py --img_backbone clip_ViT-B/32 --hidden_dim 512 --image_dim 224 --mask_dim 224 --traj_dim 224 --sync --threshold 0.00005 \
        --checkpoint {checkpoint} --glove_path E:/carla/carla/CARLA_0.9.12/glove/glove/ --target mask \
            --num_frames 8 --traj_frames 10 --attn_type multi_head --one_in_n 10\
            --sampling 5 --stop_criteria confidence --confidence 200 --min_confidence 50 --infer_dataset val --distance 5 --map {maps[episodes[i]]}\
