import os
episodes = [20, ]+list(range(25, 25))
checkpoint = './saved_model/nomap_clip/clip_ViT-B_32_class_level_combo_multi_head_hd_512_sf_10-8_tf_20_14_Jul_16_13.pth'
...
for i in range(len(episodes)):
    os.system(f"python inference_model.py --img_backbone clip_ViT-B/32 --hidden_dim 512 --image_dim 224 --mask_dim 224 --traj_dim 224 --sync --threshold 0.00005 \
        --checkpoint {checkpoint} --glove_path E:/carla/carla/CARLA_0.9.12/glove/glove/ --target mask \
            ...
            --sampling 5 --stop_criteria confidence --confidence 100 --min_confidence 20 --infer_dataset val --distance 5 --map {maps[episodes[i]]}\
